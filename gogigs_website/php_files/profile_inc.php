...
<head>
    ...
    <link rel="stylesheet" href="/gogigs/gogigs_website/css/profile.css">
                ...
                <div class="col-md-9">
                    <div class="tab-content">
                        <div class="tab-pane fade active show" id="account-general">
                            ...
                            <div class="card-body">
                                <form action="/gogigs/gogigs_website/php_files/update_profile.php" method="post">
                        ...
                        <div class="tab-pane fade" id="account-change-password">
                            <div class="card-body pb-2">
                                <form action="/gogigs/gogigs_website/include/changepassword.inc.php" method="post" class="forms_form">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="account-info">
                            <div class="card-body pb-2">
                                <form action="/gogigs/gogigs_website/php_files/update_profile_info.php" method="post">
                                    <div class="form-group">
                        ...
                        <div class="tab-pane fade" id="account-social-links">
                            <form action ="/gogigs/gogigs_website/update_profile_social.php" method="post">
                                <div class="card-body pb-2">
                                    <div class="form-group">
