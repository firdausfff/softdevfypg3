...
$result = $mysqli-> query($sql);
            if($result-> num_rows>0){
             ...
             echo "<div class='card'>
                    <a href='/gogigs/gogigs_website/html/productpage(cust).html'>
                    ...
                    <div class='content'>
                        ...
                        <div class='shortinfo'>
                            ...
                            <div class='more-info-button'>
                                <button><a href='/gogigs/gogigs_website/php_files/productpage(cust).php?event_names=" . urlencode($row['event_name']) . "'>More info</a></button>
                            </div>
                        </div>
                    </div>
                </div>";
