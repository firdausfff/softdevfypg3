...
if (isset($_POST['addevent'])) {
    ...
    $eventexpire = "upcoming";
    $query = "INSERT INTO events_current(event_name, event_image, event_date_start, event_date_finish, event_cost, event_location, event_description, events_ticketavail, event_expiry)
              VALUES ('$eventname', '$filename', '$eventdatestart','$eventdatefinish','$eventprice','$eventvenue','$eventdescription','$eventtickets','$eventexpire')";
...
<body>
            ...
            <div class="big-card">
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="width: 20%;">
                        ...
                        <input type="date" id="event-date-finish" name="event-date-finish" required>
                    </div>
                    <div class="form-group" style="width: 20%;">
    ...
    <script>
        document.getElementById('eventForm').addEventListener('submit', function(event) {
            ...
            let isValid = true;
            const fields = ['event-image', 'event-name', 'event-venue', 'event-description', 'event-price', 'event-date-start','event-date-finish', 'event-tickets'];
